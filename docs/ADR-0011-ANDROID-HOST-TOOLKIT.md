...
- 状态：**Implemented-L1（Secure 通道）**（2026-08-11）— L1 + 公共管道 + guest CLI IPC + 聊天写审批已落地  
- 日期：2026-08-11
- 优先级约束：**安全 > 能力 > 体验 > 速度**
- 相关：ADR-0005、ADR-0008、ADR-0009；**产品双通道见 [ADR-0012](ADR-0012-HOST-PRODUCT-CHANNELS.md)**
...
**Secure 通道（默认产品）批准范围：仅 L0 + L1 + Host 公共管道。**  
L2–L4 **不得**进入 Secure 的 Manifest/依赖；完整高权限实验见 **ADR-0012 Lab 通道**。
